...
<div class="drugsword" style="display: block;">
    ...
    <a href="{{$url}}">
        <div type="button" data-clipboard-text="" class="icopy" id="icopy" data-clipboard-target="#tkl"
             data-clipboard-action="copy">
            点击前往下单
        </div>
    </a>
    <div id="copy-tip" class="copy-tip"><span>点击下单</span> <span class="jtone"></span> <span>直接购买下单</span> <span
            class="jttwo"></span> <span>或加购物车</span> <span class="jtthree"></span> <span>至APP下单</span></div>
</div>
<div class="info-card" style="margin-top: 10px">
    <div class="box1 bottom">
        ...
        <span style="color: red;">红包/京豆/e卡等相当于实付，不影响返现</span><br>
        <br>
        ①使用大促期间的
        <span style="color: red;">超级红包，</span>可能会导致无法跟单。<br>
        ②下单后2分钟内会收到<span style="color: red;">跟单成功通知</span>，如未收到或查询不到订单，请发订单号给我绑定<br>
        ③需要使用极速版/京喜下单的，您可以通过链接加入到购物车，然后去指定APP下单<br>
    </div>
</div>
